...
Con este primer modelo estaríamos explicando un 85,6% de la variabilidad de la energía producida (valor del R cuadrado) con un error absoluto medio (MAE) de 16,72. Creo que con estos resultados me puedo arriesgar para un primer envío (random forest 10 arboles, variance) 
              num.trees = 10,
               splitrule = "variance",
               min.node.size = 1,
                seed = 42)
                
Mismo modelo pero con 500 arboles y min node size = 5               
                num.trees = 500,
               splitrule = "variance",
               min.node.size = 1,
                seed = 42)
